            ...
            return (
              ...
              >
                <div>
                  ...
                  {/* Personal Progress */}
                  <div className="mb-3 sm:mb-4 p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-r from-slate-50/90 to-brand-50/40 border border-slate-200/70 shadow-soft-xs">
                    <ProgressBar
